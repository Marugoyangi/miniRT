...
/*   Updated: 2024/02/29 07:20:04 by jeongbpa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	set_light(t_minirt *minirt, t_p_node *node)
{
	...
	obj = object(SPHERE, sphere(node->coord, 2, light, vec(0, 0, 0)));
	_light = object(SPHERE, sphere(node->coord, 2, light, vec(0, 0, 0)));
...
void	set_ambient(t_minirt *minirt, t_p_node *node)
{
	...
	ratio = node->geometric[0] * 0.0001 * 255;
